...
<?php
            if (isset($_POST['simpan'])) {
                ...
                $sql1   = "INSERT INTO pemesanan(nama, nomerHP, alamat, keterangan, harga, hariPemesanan, hariSelesai,sudahBayar) VALUES ('$name','$nomerHP','$alamat','$deskripsi','$harga','$tglPesan','$tglJadi','$sudahBayar')";
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="harga" name="harga" class="form-control" 
                                                            required>
                                                        <p class="text-danger"></p>
                                                    </div>
                                                    <div class="form-group">
